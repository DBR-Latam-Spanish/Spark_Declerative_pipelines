...
class WorkshopHelper:
    def __init__(self):
        ...
        # CAMBIAR CATÁLOGO COMPARTIDO - todos los usuarios usaran este catalogo!!!
...
# Limpiar solo los esquemas del usuario en el catálogo compartido
print(f"Limpiando esquemas previos del usuario en catálogo: {DA.catalog_name}")
...
for schema in user_schemas:
    try:
        ...
        print(f"✓ Esquema limpiado: {DA.catalog_name}.{schema}")
    except Exception as e:
        print(f"Nota: No hay esquema previo {schema} que limpiar (normal en primera ejecución)")

print(f"\n📝 NOTA: Solo se limpian los esquemas del usuario, NO el catálogo compartido '{DA.catalog_name}'")
